...
class sever(object):
    ...
    def deal(self, tcpClientSock, addr):
        ...
        while True:
            ...
            sqlString = "INSERT INTO `factory01scale001newval2018-05-07`(`Timestamp`, `WeightTag1`, `WeightTag2`, `WeightTag3`, `WeightTag4`) VALUES"
            ...
            try:
                self.cursor.execute(sqlString[:len(sqlString) - 1])
                self.cnn.commit()
